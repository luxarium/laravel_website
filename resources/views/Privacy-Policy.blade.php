...
<div id="content">
    ...
    <div class="row_6" style="background-image: url(/public/img/pattern2.jpg)">
        <div class="container">
            ...
            <p class="Per-Font-Parag" style="font-size: 16px">&bull; وب‌سایت لوکساریوم، طبق قوانین جهوری اسلامی ایران، قوانین جرائم اینترنتی و مجموعه‌ی قوانین و مقررات تجارت الکترونیکی فعالیت می‌نماید و کاربران محترم آن موظفند هیچ‌گونه مطالب سیاسی و یا مغایر با شؤونات اخلاقی و مذهبی کشور ایران را در این وب‌سایت قرار ندهند. در صورت اثبات این امر، شناسه‌ی کاربری این افراد لغو شده و تبعات این موضوع نیز بر عهده‌ی خود ایشان خواهد بود.</p>

            <p class="Per-Font-Parag" style="font-size: 16px">&bull; حقوق معنوی محتوایی که توسط کاربران وب‌سایت لوکساریوم تولید شده و بر روی این وب‌سایت قرار می‌گیرد، متعلق به این مجموعه است: وب‌سایت لوکساریوم حق ویرایش، حذف و یا بازنشر این محتویات را برای خود محفوظ می‌دارد.</p>

            <p class="Per-Font-Parag" style="font-size: 16px">&bull; وب‌سایت لوکساریوم اطلاعات کاربران را با هیچ مجموعه‌ی دیگری به اشتراک نخواهد گذاشت و مراجع ذی‌صلاح فقط در صورت موارد مصرح در قانون، امکان استفاده از این اطلاعات را خواهند داشت.</p>

            <p class="Per-Font-Parag" style="font-size: 16px">&bull; هر گونه سوء استفاده از نام Luxarium(لوکساریوم)، سایت اینترنتی لوکساریوم، مکاتبه از طرف مجموعه لوکساریوم و یا استفاده از نام های مشابه که شبهه مشابهت و تطابق را ایجاد نماید ممنوع بوده از طریق شکایت به مراجع قانونی ذی‌صلاح، دادگاه‌های رسیدگی به جرائم اینترنتی در داخل و یا خارج از کشور و نیز اطلاع‌رسانی به سرویس دهندگان و سرویس گیرندگان اینترنتی قابل پیگرد خواهد بود.</p>
        </div>
    </div>
