                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" role="tab" id="headingOne">
                            <h4 class="panel-title asd">
                                <a class="pa_italic Per-Font" data-toggle="collapse"  aria-expanded="true" aria-controls="collapseOne">
                                    {{$d->users()->get()[0]->firstName}} {{$d->users()->get()[0]->lastName}}
                                    <span class="glyphicon glyphicon glyphicon-chevron-down" aria-hidden="true"></span><i class="glyphicon glyphicon-menu-up" aria-hidden="true"></i>
                                </a>
                            </h4>
                        </div>
                    </div>
